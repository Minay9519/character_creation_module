...
def start_training(char_class):
    ...
    approve_choices: str  = None
    
    if approve_choices != 'Skip':
        selected_class = input('Потренируйся управлять своими навыками.'
        ...
        for approve_choices in commands:
            print(commands[approve_choices]())
